...
```c++ class BIS_fnc_effectKilledAirDestruction { allowedTargets=2; };```                                             
...
If you using infiSTAR you need to add this line to your CfgRemoteExec.hpp instead of discription.ext               
Steb 3b
