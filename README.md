...
#### Step 2
If you like to have sounds of hooting sirens, put the Folder **__Sounds__** to your mission.pbo (for example **__Exile.Altis.pbo__**) Otherwise skip ***Step 3*** and go to **__ACME_TNT.pbo\server\ACME_TNT.sqf__** and set on line 69 **__ _ambientSound__** to **__false__**.
